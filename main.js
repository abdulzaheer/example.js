      ...
      document.write("At Index 2 : ", randStr.charAt(4) + "<br/>");
      /* In this case .chart(6) returns
      the 2nd character of the string: " " *///a blank space
      document.write("At Index 2 : ", randStr.charAt(6) + "<br/>");
      /* In this case .chart(10) returns
      the 2nd character of the string: i */
      document.write("At Index 2 : ", randStr.charAt(10) + "<br/>");
      /* In this case .chart(19) returns
      the 2nd character of the string: g */
      document.write("At Index 2 : ", randStr.charAt(19) + "<br/>");

      //Split a string into an array with the .split() function.
